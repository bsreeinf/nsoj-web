...
#
permit_params :title, :content, :story_category_id, :blog_image, :image_caption, :created_at, :slug, :video_link, :video_caption, authors_attributes: [:student_id, :story_id]
#
# or
#
# permit_params do

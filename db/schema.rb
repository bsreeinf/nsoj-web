...
ActiveRecord::Schema.define(version: 20170329234909) do
  ...
  create_table "admissions_2016_bkp", id: false, force: :cascade do |t|
    t.integer  "id"
    t.integer  "user_id"
    t.string   "form_token"
    t.string   "first_name1"
  ...
  add_index "students", ["slug"], name: "index_students_on_slug", using: :btree

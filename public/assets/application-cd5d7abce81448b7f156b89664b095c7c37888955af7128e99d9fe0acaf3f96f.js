...
function initPageSliders(){
    (function($){
        ...
        // fullwidth slider custom
        $(".fullwidth-slider-custom").owlCarousel({
            autoPlay: 12000,
            stopOnHover: true,
            items: 1,
            itemsDesktop: [1199, 3],
...
/* ---------------------------------------------
     Fullscreen menu
   --------------------------------------------- */
    /*Bottom two variables are not required, but still keeping it for testing purposes*/
...
/* ---------------------------------------------
     Side panel
   --------------------------------------------- */
    /* Bottom four variables are not required, but still keeping it for testing purposes */
        ...
        if (gmMapDiv.length) {
            ...
            gmMapDiv.gmap3({
                ...
                marker: {
                    ...
                    options: {
                        icon: "/assets/map-marker-f34a57878474344f668d612f763ca270f4446588ea58a4bb1ed422d1c960b96b.png"
                    }
                },
                map: {
                    options: {
